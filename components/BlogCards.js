      ...
      <div className={clsx(
        ...
        {cards.map((card, i) => (
          <a key={`video-card-${i}`}
            ...
            <div className={'flex items-center relative justify-center relative h-36 lg:h-52 rounded-t-2xl'}
            ...
            <div className={`py-12 md:py-8 h-[calc(100%-9rem)] lg:h-[calc(100%-13rem)] flex flex-wrap ${card.image ?"px-10":"px-8"}`}>

              <h3 className='text-2xl md:text-3xl mb-6 md:mb-4 font-bold'>{card.headline}</h3>
