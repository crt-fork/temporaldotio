  ...
  return <ColumnLayout
    left={
      <div className="lg:col-span-7 xl:col-span-6 lg:row-end-1">
        <h2 className="mt-8 font-semibold text-sky-500">Component-driven</h2><p className="mt-4 text-3xl sm:text-4xl text-slate-900 font-bold tracking-tight dark:text-slate-50 ">
