    ...
    <div>
      ...
      <section className='mt-20 sm:mt-32 lg:mt-64 xxl:mt-96'>
        <CallOut
          ...
          copy={{
            ...
            subhead: "Just because the services you depend on are unreliable doesn't mean your application has to be."
          }}/>
        <div className="mb-32">
        <Video
          poster={'/images/video-static.png'}
          url={'/videos/Temporal_Intro_Video1.mp4'}
          isMuted={true}
          autoplay={true}
          copy={{
      ...
      <section className='mt-20 sm:mt-32 lg:mt-64 xxl:mt-96'>
        <PointsLogo copyPoints={[
          ...
          {
            heading: 'Reliable',
            copy: <>Your code will run <br /> despite failures!</>
          },
          {
            heading: 'Scalable',
            copy: <>Your code can scale up <br /> or down on command!</>
          }
        ]}/>
      </section>
        ...
        <div className='container mx-auto px-8 sm:px-10 grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8 align-items-center'>
          <div className='flex justify-end'>
            <SplitCard
              ...
              copy={<>
                <p>
                  Our flagship product. The most fully featured platform to write & run
                  your stateful applications with the largest user community. Years of
                  maturation across hundreds of high scale applications. MIT license.
                </p>
                <a class="underline mt-5 inline-block" href="https://docs.temporal.io/">Get Started</a>
              </>}
              color='light'
              />
          </div>
          <div className='flex justify-start'>
            <SplitCard
              ...
              copy={<>
                <p>
                Outsource the configuration, infrastructure, operations and maintenance of Temporal to us.  Pay only for what you use.  100% compatible with open source Temporal.
                </p>
                <a class="underline mt-5 inline-block" target="_blank" href="https://us17.list-manage.com/survey?u=2334a0f23e55fd1840613755d&id=f1895b6f4a">Join the Cloud Waitlist</a>
              </>}
              color='dark'
            />
          </div>
      ...
      <section className='mt-20'>
        <CallOutTweet
          ...
          copy={{
            ...
            subhead: <>The application state management< br/> platform you know you need.</>,
