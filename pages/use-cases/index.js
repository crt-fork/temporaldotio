...
export default function Users() {
  const customers = [
    ...
    { copy: 'Doordash logo',  logo: '/images/logos/doordash-white.svg' },
  ]
  return (
    <div>
      <section>
        ...
        <Hero
          copy={{
            title: 'index',
            headline: "Our users define us.",
            subhead: "Real life stories and real world solutions."
          }}
      ...
      <section className='mt-8 lg:mt-28 text-center'>
        <CallOut
          ...
          subhead: "Temporal is the open source microservice orchestration platform for writing durable workflows as code."
        }}/>
      </section>
      <section
        ...
        <CallOut
          ...
          subhead: 'No more double spends or dropped payments. Reliability, consistency, failure compensation, long running operations, and distributed transactions for your most critical transfers.'
        }}>
          {/* TODO: TO MAKE CMS READY, Make RichText Capable w/ dangerouslySetInnerHTML */}
          <Expander
            closedCopy={'Show more about Distributed Transactions'}
            expandedCopy={'Show less about Distributed Transactions'}>
              <ProCons
      ...
      <section
        ...
        <CallOut
          ...
          key={uuid()}
          copy={{
            headline: "Async Business Processes.",
            subhead: "Distributed Cron, at massive scale. Reliable polling that is as simple or sophisticated as you need. Run 100s of millions parallel cron jobs that survive any machine failure."
          }}>
          <Expander
