  ...
  footer: {
    ...
    linkColumns: [
      ...
      },
      {
        ...
        links: [
          { copy: 'business transactions', target: '_self', href: '/use-cases#business-transactions' },
          { copy: 'business process applications', target: '_self', href: '/use-cases#async-business-processes' },
      ...
      },
      {
        ...
        links: [
          { copy: 'We\'re hiring', target: '_blank', href: 'https://jobs.lever.co/temporal' },
        ]
      }
    ],
    legalItems: [
    ...
    partners: [
      {
        image: { src: '/images/logos/logo-Index-v2.svg', alt: 'Index Ventures logo icon'},
...
function MyApp({ Component, pageProps }) {
  ...
  const [showAnnouncement, setShowAnnouncement] = useState(data.announcement.showAnnouncement);
